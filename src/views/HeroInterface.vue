...
interface HeroList {
  ...
  description: string;
  img: string;
  config: [string, number, number, number, number, number, number, number];
}
...
const heroList = ref<Array<HeroList>>([
  {
    ...
    img: Warrior,
    config: ["戰士 Warrior", 250, 10, 100, 80, 50, 0, 1],
  },
  {
    name: "法師 Mage",
    description:
    ...
    img: Mage,
    config: ["法師 Mage", 250, 10, 100, 80, 50, 0, 1],
  },
  {
    name: "獵人 Hunter",
    description:
    ...
    img: Hunter,
    config: ["獵人 Hunter", 250, 10, 100, 80, 50, 0, 1],
  },
  {
    name: "盜賊 Rogue",
    description:
    ...
    img: Rogue,
    config: ["盜賊 Rogue", 250, 10, 100, 80, 50, 0, 1],
  },
]);
...
<template>
  ...
  <div class="interface">
    <div
      ...
      :key="hero.name"
      @click="chooseHero(hero.config, hero.img)"
    >
